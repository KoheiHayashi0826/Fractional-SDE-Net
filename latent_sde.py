...
if __name__ == '__main__':
    ...
    parser.add_argument('--no-gpu', type=str2bool, default=True, const=True, nargs="?")
    ...
    parser.add_argument('--train-iters', type=int, default=100, help='Number of iterations for training.')
